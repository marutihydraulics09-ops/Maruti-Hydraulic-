...
import { ArrowRight, Search, SlidersHorizontal, Settings2 } from 'lucide-react';
    ...
    <>
      ...
      <section className="py-12 md:py-20 bg-dark-bg">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          {/* Search and Filters */}
          <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-12 bg-white/5 border border-white/5 p-4 sm:p-6 rounded-2xl w-full">
            {/* Search Box */}
            ...
            {/* Filter Buttons — 3-column tab list on mobile, flex row on desktop */}
              ...
              {[
                ...
                <button
                  ...
                  className={`py-2 px-1 sm:px-4 sm:py-2.5 rounded-xl text-[10px] sm:text-xs font-manrope font-semibold uppercase tracking-wider transition-all duration-300 cursor-pointer text-center ${selectedType === tab.type
                    ? 'bg-accent text-dark-bg font-extrabold shadow-[0_0_15px_rgba(0,194,255,0.35)]'
          ...
          {/* Grid display — 2 cols on mobile, 2 on tablet, 3 on desktop */}
